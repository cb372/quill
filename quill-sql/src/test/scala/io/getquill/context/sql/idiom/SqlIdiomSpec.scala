...
//                mirror.prepareRow mustEqual Row(param)
//              }
...
//          }
//          val run = testContext.run(q)(List(TestEntity("s", 1, 2L, Some(1)))).string mustEqual
...
//        testContext.run(infix"DELETE FROM TestEntity".as[Action[TestEntity, Long]]).string mustEqual
//          "DELETE FROM TestEntity"
//      }
//    }
//    "if" - {
